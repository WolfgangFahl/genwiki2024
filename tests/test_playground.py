    ...
    def test_thumbnail_generation(self):
        ...
        for size in test_sizes:
            with self.subTest(size=size):
                thumbnail_url = self.playground.get_thumbnail_url(original_url, size=size)
                ...
                self.assertTrue(thumbnail_url.startswith("https://upload.wikimedia.org/wikipedia/commons/thumb/"))
