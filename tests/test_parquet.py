...
class TestParquet(Basetest):
    ...
    def setUp(self, debug=True, profile=True):
        ...
        self.genwiki_examples_folder = os.path.join(current_folder, "..", "genwiki_examples")
        # Ensure the directory exists
        self.assertTrue(os.path.exists(self.genwiki_examples_folder), f"Directory not found: {self.genwiki_examples_folder}")
    ...
    def test_queries(self):
        ...
        qm = QueryManager(lang="sql", queriesPath=yaml_path, with_default=False,debug=self.debug)
